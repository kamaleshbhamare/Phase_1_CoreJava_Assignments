package day8.assignment.ExponentialSearch;
...
public class ExponentialSearch {
	...
	public static void main(String[] args) {
		...
		int arr[] = {1, 3, 6, 8, 11, 23, 56, 75, 87, 98, 102, 124, 152, 168, 190, 202};
		...
		*/ 
		...
		findExponential(0, arr.length-1, arr, elem);
		
		input.close();
		
	}
	
	public static void findExponential(int l, int h, int[] arr, int ele) {
